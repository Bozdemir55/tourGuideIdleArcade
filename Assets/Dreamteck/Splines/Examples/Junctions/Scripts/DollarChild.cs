namespace Dreamteck.Splines.Examples
{
    ...
    public class DollarChild : MonoBehaviour
    {
        ...
        void SetupRecursively(DollarChild frontWagon, SplineSegment inputSegment)
        {
            front = frontWagon;
        ...
        DollarChild GetRootWagon()
        {
            DollarChild current = this;
